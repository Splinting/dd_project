module gameControl (input sys_clk, clk_d,
    ...
    wire timer_en;
    fsm fsm(clk_d,rst,start_sw,win_flag,active,game_status,step_number,timer_en);
    play pC(game_status,clk_d,rst,act_flag,random_sw,set_flag,board_num_sw,possi_led,out,win_flag);
